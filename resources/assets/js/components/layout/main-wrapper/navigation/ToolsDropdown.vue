<template>
 ...
 -->
      ...
      <!-- <NavDropdownItem v-if="isAdmin" target="#">
                <button class="dropdown-item hover:bg-brand-blue-light-3 p-3" :disabled="creatingInvoices"
                    :class="{ 'cursor-not-allowed': creatingInvoices }" @click.prevent="triggerInvoicingProcess">
...
import { faList, faPhotoFilm, faTicket } from '@fortawesome/free-solid-svg-icons'
...
const APP_MEDIA_OPEN_HOMES_ADMIN_PATH = '/atrium/admin'
const APP_MEDIA_OPEN_HOMES_VA_PATH = '/atrium/va'
// const APP_MUSIC_OPEN_HOMES_URL = ''
const APP_MEDIA_OPEN_HOMES_URL = window.MEDIA_APP_URL
